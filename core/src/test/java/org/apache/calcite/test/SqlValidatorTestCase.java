...
public class SqlValidatorTestCase {
  ...
  /**
   * Checks that a SQL query gives a particular error, or succeeds if {@code
   * expected} is null, but with no allows type coercion.
   */
  public final void checkFails(
      String sql,
      String expected,
  ...
  /**
   * Checks that a SQL expression gives a particular error, but type coercion is not allowed.
   */
  public final void checkExpFails(
      String sql,
      String expected,
  ...
  /**
   * Checks that a SQL expression gives a particular error, and that the
   * location of the error is the whole expression, also the type coercion is off.
   */
  public final void checkWholeExpFails(
      String sql,
      String expected,
